...
std::string CmtAstCnsm::BrcOkFlagText="__BrcOkFlagText";//TODO_ 改为 static

 bool CmtAstCnsm::HandleTopLevelDecl(DeclGroupRef DG) {
...
void CmtAstCnsm::__visitFullComment(const RawComment *C,bool & flag) {
  if(!C){
    return;
  }
